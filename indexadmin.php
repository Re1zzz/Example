                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-6 fw-bolder text-white mb-2">Hello! <b><?php echo $result['username']; ?></b>! Bagaimana kabarmu hari ini?</h1>
                            <p class="lead text-white-50 mb-4">Semangat jalani hari-harimu ya! Tetap semangat jangan menyerah~</p>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-primary btn-lg px-4 me-sm-3" href="homeadmin.php">Lihat Shop</a>
                                <a class="btn btn-outline-light btn-lg px-4" href="order.php">Lihat Orderan</a>
                            </div>
                        </div>
                    </div>
                </div>
