  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold text-black">DATA PESANAN PELANGGAN</h3>
        <br>
      </div>
      <table class="table table-bordered shadow" id="example">
        ...
        <tbody class="table-light " align="center">
          <?php $nomor=1; ?>
          <?php 
            $ambil = mysqli_query($c, 'SELECT * FROM pemesanan');
          ...
          <tr>
            ...
            <td>
              <center>
              <a href="detail.php?id=<?php echo $result['id_pemesanan'] ?>" class="btn btn-primary shadow">Detail</a>
              <a href="endorder.php?id=<?php echo $result['id_pemesanan'] ?>" class="btn btn-danger shadow">Selesai</a>
              </center>
            </td>
          </tr>
          <?php $nomor++; ?>
